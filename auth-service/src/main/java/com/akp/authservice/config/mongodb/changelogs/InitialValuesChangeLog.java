package com.akp.authservice.config.mongodb.changelogs;

import com.akp.authservice.domain.AuthClientDetails;
import com.akp.authservice.domain.User;
import com.akp.authservice.enums.Authorities;
...
public class InitialValuesChangeLog {
    ...
    @ChangeSet(order = "001", id = "insertBrowserClientDetails", author = "AKP")
    ...
    @ChangeSet(order = "002", id = "insertUserToTestAuthentication", author = "AKP")
    ...
    @ChangeSet(order = "003", id = "insertAccountServiceClientDetails", author = "AKP")
